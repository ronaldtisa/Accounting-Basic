...
Public Class DeleteItemView
    ...
    Private Sub inventory_delete_search_ItemName_TextChanged(sender As Object, e As EventArgs) Handles inventory_delete_search_ItemName.TextChanged
        sql2 = "SELECT Code, ProductName, Company_Id, Item_Id, Quantity, UnitPrice, UnitTax Telephone FROM Inventory WHERE ProductName Like '%" & inventory_delete_search_ItemName.Text & "%'"
        searchData2()
    End Sub
